        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              <img src={logo} alt="StudySphere Logo" className="w-auto h-15 mr-3" />
            </div>
            <p className="text-slate-300 mb-4 leading-relaxed">
              Nền tảng chia sẻ tài liệu học tập với công nghệ AI tiên tiến. Kết nối sinh viên, trao
              đổi kiến thức và xây dựng cộng đồng học tập mạnh mẽ.
            </p>
